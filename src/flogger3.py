...
#        print "settings.FLOGGER_DB_SCHEMA: ", settings.FLOGGER_DB_SCHEMA
        ...
        def set_keepalive(sock, after_idle_sec=1, interval_sec=3, max_fails=5):
            ...
            if hasattr(socket, "TCP_KEEPIDLE") and \
                ...
                print "Set TCP_KEEPIDLE, TCP_KEEPINTVL, TCP_KEEPCNT"
            else:
                print "Socket doesn't have TCP_KEEPIDLE, TCP_KEEPINTVL, TCP_KEEPCNT so ignore"
...
#                    self.RunningLabel.setText("Sleeping")
                ...
                print "FLOGGER_KEEPALIVE_TIME is: ", settings.FLOGGER_KEEPALIVE_TIME
...
#                        print "Raw APRS Packet: ", packet_str
        #                datafile.write(packet_str)
                    ...
                    print "Socket error on readline. Error: ", e
                    sys.exit()
